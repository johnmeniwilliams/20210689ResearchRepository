...
time.sleep(20) # pause function allows code to pause in seconds, discuss canvas, title, gridline, spacebar sound
...
time.sleep(10) # discuss stop use spacebar sound, auto sound event
